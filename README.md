...
| <img src="https://avatars.githubusercontent.com/Ubermensch0608" width="100px;" alt=""/> | <img src="https://avatars.githubusercontent.com/crucial-sub" width="100px;" alt=""/> | <img src="https://avatars.githubusercontent.com/ttaerrim" width="100px;" alt=""/> | <img src="https://avatars.githubusercontent.com/penguin311" width="100px;" alt=""/> |
| :-------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------: |
|                                         우종원                                          |                                        박중섭                                        |                                      이태림                                       |                                       임수영                                        |
|                메시지 데이터 동적 관리, 메시지 입력 기능, 전역상태 관리                 |                    메시지 삭제 기능, 메인 페이지 해더 및 좌측네브                    |                         메시지 답장 기능, 전역 상태 관리                          |                    로그인&아웃, 유저 모델, 메인 페이지 스타일링                     |
